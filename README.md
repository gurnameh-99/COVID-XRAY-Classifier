...
- In this repository, a model for classifying the cases of COVID-19 has been provided.
- A descriptive EDA of the dataset has been provided.
- The model has been implemented in Python using tensorflow.
- This is a deep neural network model that uses a convolutional neural network to classify the cases of COVID-19.
